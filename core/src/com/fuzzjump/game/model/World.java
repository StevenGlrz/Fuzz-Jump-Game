...
import com.fuzzjump.game.game.ingame.actors.PhysicActor;
...
public class World {
    ...
    public static final float FRAME_DT = .01f;
    private final GameScreen screen;

    private ArrayList<PhysicActor> physicsActors = new ArrayList<PhysicActor>();
	...
	public World(FuzzJump game, GameScreen screen, long seed, float width, float height) {
		this.game = game;
		this.width = width;
		this.height = height;
        this.screen = screen;
    ...
    public ArrayList<PhysicActor> getPhysicsActors() {
